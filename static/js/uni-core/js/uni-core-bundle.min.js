/*! UniCore 3.19.1 | https://www.unistudio.co | (c) 2023 - 2024 UniStudio | MIT License */ ! function(t, e) {
    "object" == typeof exports && typeof module < "u" ? module.exports = e(require("animejs")) : "function" == typeof define && define.amd ? define("uikit", ["animejs"], e) : (t = typeof globalThis < "u" ? globalThis : t || self).UniCore = e(t.anime)
}(this, (function(t) {
    "use strict";
    const {
        hasOwnProperty: e,
    ...
    function N(t, e) {
        return t === e || v(t) && v(e) && Object.keys(t).length === Object.keys(e).length && F(t, ((t, i) => t === e[i]))
    }
    ...
    function Z(t, e, i = 0, n = !1) {
        ...
        return s ? (t = T(t) ? P(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : "last" === t ? s - 1 : e.indexOf(_(t)), n ? V(t, 0, s - 1) : (t %= s) < 0 ? t + s : t) : -1
    }
    ...
    function lt(t, e, i) {
        ...
        A(i) || (i = !!i);
        for (const e of B(t))
            for (const t of n) e.classList.toggle(t, i)
    }
        ...
        if (t = Ot(t), Mt(t)) {
            ...
            for (let n of i) {
                ...
                if ("!" === n[0]) {
                    ...
                    if (s = vt(e).closest(t[0]), n = t.slice(1).join(" ").trim(), !n.length && 1 === i.length) return s
                }
                if ("-" === n[0]) {
                    const t = n.substr(1).trim().split(" "),
    ...
    function Lt(...t) {
        ...
        }(s)), null != o && o.self && (s = function(t) {
            return function(e) {
                if (e.target === e.currentTarget || e.target === e.current) return t.call(null, e)
            }
        }(s)), n && (s = function(t, e) {
            return i => {
                const n = ">" === t[0] ? Dt(t, i.currentTarget).reverse().find((t => t.contains(i.target))) : i.target.closest(t);
                n && (i.current = n, e.call(this, i), delete i.current)
            }
        }(n, s));
        for (const t of i)
            for (const i of e) i.addEventListener(t, s, o);
        return () => Wt(e, i, s, o)
    }
    ...
    function Wt(...t) {
        let [e, i, , n, s = !1] = Ut(t);
        for (const t of i)
            for (const i of e) i.removeEventListener(t, n, s)
    }

    function qt(...t) {
        const [e, i, n, s, o = !1, r] = Ut(t), a = Lt(e, i, n, (t => {
            const e = !r || r(t);
            e && (a(), s(t, e))
        }), o);
        return a
    ...
    function Rt(t, e = !0, i = !1, n) {
        return k(t) && (t = new CustomEvent(t, {
            bubbles: e,
            cancelable: i,
            detail: n
        })), t
    ...
    function Qt(t, e, i, n) {
        ...
        for (const t of s)
            if (k(e)) {
                ...
                if (v(e))
                    for (const n in e) Qt(t, n, e[n], i)
            }
        return s[0]
    }
    const te = K((t => function(t) {
        if (h(t, "--")) return t;
        t = o(t);
        const {
            style: e
    ...
    const se = {
            start: function(t, e, i = 400, n = "linear") {
                return i = Math.round(i), Promise.all(B(t).map((t => new Promise(((s, o) => {
                    for (const i in e) {
                        const e = Qt(t, i);
                        "" === e && Qt(t, i, e)
                    }
    ...
    function le(t, e, i = 200, n, s) {
        return Promise.all(B(t).map((t => new Promise(((o, r) => {
            Vt(t, ae);
            const a = setTimeout((() => Vt(t, re)), i);
            qt(t, [re, ae], (({
                type: e
            }) => {
                clearTimeout(a), e === ae ? r() : o(t), Qt(t, "animationDuration", ""), ot(t, `${oe}\\S*`)
            }), {
                self: !0
            }), Qt(t, "animationDuration", `${i}ms`), nt(t, e, oe + (s ? "leave" : "enter")), h(e, oe) && (n && nt(t, `uc-transform-origin-${n}`), s && nt(t, `${oe}reverse`))
        })))))
    }
    ...
    function ye(t) {
        B(t).map(vt).filter(((t, e, i) => i.indexOf(t) === e)).forEach((t => t.replaceWith(...t.childNodes)))
    }
    const Se = /^<(\w+)\s*\/?>(?:<\/\1>)?$/;
    ...
    function Pe(t) {
        const e = y(t) ? _(t).getBoundingClientRect() : {
            height: Oe(t),
            width: Ne(t),
            top: 0,
            left: 0
    ...
    function _e(t) {
        ...
        return {
            top: e - M(Qt(t, "marginTop")),
            left: i - M(Qt(t, "marginLeft"))
        }
    }
    ...
    function Be(t) {
        ...
        for (; t = t.offsetParent;)
            if (e[0] += t.offsetTop + M(Qt(t, "borderTopWidth")), e[1] += t.offsetLeft + M(Qt(t, "borderLeftWidth")), "fixed" === Qt(t, "position")) {
                const i = O(t);
    ...
    function He(t, e, i = "border-box") {
        return Qt(t, "boxSizing") === i ? L(De[e].map(l), (e => M(Qt(t, `padding${e}`)) + M(Qt(t, `border${e}Width`)))) : 0
    }

    function Fe(t) {
        for (const e in De)
            for (const i in De[e])
                if (De[e][i] === t) return De[e][1 - i];
        return t
    }
    ...
    function je(t, e = "width", i = window, n = !1) {
        return k(t) ? L(We(t), (t => {
            ...
            return s ? function(t, e) {
                return t * M(e) / 100
            }("vh" === s ? Re || (Ue || (Ue = Te("<div>"), Qt(Ue, {
                height: "100vh",
                position: "fixed"
            }), Lt(window, "resize", (() => Re = null))), me(document.body, Ue), Re = Ue.clientHeight, be(Ue), Re) : "vw" === s ? Ne(O(i)) : n ? i[`offset${l(e)}`] : Pe(i)[e], t) : t
        })) : M(t)
    }
    ...
    function ri(t) {
        ni.scheduled || (ni.scheduled = !0, t && t < oi ? Promise.resolve().then((() => si(t))) : requestAnimationFrame((() => si(1))))
    }
    ...
    class hi {
        init() {
            let t;
            this.positions = [], this.unbind = Lt(document, "mousemove", (e => t = Zt(e))), this.interval = setInterval((() => {
    ...
    function ui(t, e, i = {
        ...
        return {
            disconnect: () => n.map((t => t()))
        }
    }

    function fi(t) {
        return {
            disconnect: Lt([window, window.visualViewport], "resize", t)
        }
    }
    ...
    function Ei(t, {
        ...
        return i.reduce(((n, s, o) => {
            const {
                scrollTop: r,
                scrollHeight: a,
                offsetHeight: l
            } = s, h = _i(s), c = a - h.height, {
                height: d,
                top: u
            } = i[o - 1] ? _i(i[o - 1]) : Me(t);
            let f = Math.ceil(u - h.top - e + r);
            return e > 0 && l < d + e ? f += e : e = 0, f > c ? (e -= f - c, f = c) : f < 0 && (e -= f, f = 0), () => function(t, e, n, s) {
                return new Promise((o => {
                    ...
                    ! function f() {
                        ...
                        t.scrollTop = Math[e + m > 0 ? "max" : "min"](t.scrollTop, r + (e + m) * p), 1 !== p || d !== m && u-- ? (d = m, requestAnimationFrame(f)) : o()
                    }()
                }))
            }(s, f - r, t, c).then(n)
        }), (() => Promise.resolve()))()
    ...
    function Di(t, e = !1, i = []) {
        ...
        return ~o && (s = s.slice(o)), [n].concat(s.filter((t => Qt(t, "overflow").split(" ").some((t => d(["auto", "scroll", ...i], t))) && (!e || t.scrollHeight > _i(t).height)))).reverse()
    }
    ...
    function _i(t) {
        ...
        if (b(i) && e.visualViewport) {
            ...
            return t = Math.round(t * n), i = Math.round(i * n), {
                height: t,
                width: i,
                top: s,
                left: o,
        ...
        for (let [e, s, o, r] of [
            ...
            const a = n[e] % 1;
            n[e] = n[s] = i[`client${l(e)}`] - (a ? a < .5 ? -a : 1 - a : 0), n[r] = n[e] + n[o]
        }
        return n
    }
    ...
    function Bi(t) {
        ...
        return t.ownerDocument.elementsFromPoint(e + i / 2, n).find((e => !e.contains(t) && !at(e, "uc-togglable-leave") && (Ni(e, "fixed") && Oi(yt(t).reverse().find((t => !t.contains(e) && !Ni(t, "static")))) < Oi(e) || Ni(e, "sticky") && vt(e).contains(t))))
    }
    ...
    function Ri(t, e, i, n) {
        const [s, o, r, a] = Hi[n], [h] = Ui(t, e), c = _i(h);
        return ["auto", "scroll"].includes(Qt(h, `overflow-${o}`)) && (c[r] -= h[`scroll${l(r)}`], c[a] = c[r] + h[`scroll${l(s)}`]), c[r] += i, c[a] -= i, c
    }
    ...
    function Yi(...t) {
        let e = {};
        for (const i of t)
            for (const [, , t, n] of Hi) e[t] = Math.max(e[t] || 0, i[t]), e[n] = Math.min(...[e[n], i[n]].filter(Boolean));
        return e
    }
    ...
    function Ji(t, e, {
        ...
        return Li(t, e, {
            attach: {
                element: Zi(n.element, s),
                target: Zi(n.target, s)
            },
            offset: Qi(i, s)
        })
    }
    ...
    function Gi(t, e, i) {
        return ji(t, e, { ...i,
            attach: {
                element: i.attach.element.map(Ki).reverse(),
                target: i.attach.target.map(Ki).reverse()
            },
    ...
    var sn = {
        ...
        connected() {
            Q(this.$el, "role", this.role), this.date = M(Date.parse(this.$props.date)), this.end = !1, this.start()
        },
        disconnected() {
            this.stop()
        },
        ...
        methods: {
            start() {
                this.stop(), this.update(), this.timer || (Vt(this.$el, "countdownstart"), this.timer = setInterval(this.update, 1e3))
            },
            stop() {
            ...
            update() {
                ...
                for (const e of nn) {
                    ...
                    n = n.length < 2 ? `0${n}` : n, i.textContent !== n && (n = n.split(""), n.length !== i.children.length && fe(i, n.map((() => "<span></span>")).join("")), n.forEach(((t, e) => i.children[e].textContent = t)))
                }
            }
        }
    };
    ...
    function cn(t, e = []) {
        try {
            return t ? h(t, "{") ? JSON.parse(t) : e.length && !d(t, ":") ? {
                [e[0]]: t
            } : t.split(";").reduce(((t, e) => {
                const [i, n] = e.split(/:(.*)/);
    ...
    function dn(t, e) {
        return t === Boolean ? D(e) : t === Number ? P(e) : "list" === t ? function(t) {
            return f(t) ? t : k(t) ? t.split(un).map((t => T(t) ? P(t) : D(t.trim()))) : [t]
        }(e) : t === Object && k(e) ? cn(e) : t ? t(e) : e
    }
    on.events = on.watch = on.observe = on.created = on.beforeConnect = on.connected = on.beforeDisconnect = on.disconnected = on.destroy = an, on.args = function(t, e) {
        return !1 !== e && an(e || t)
    ...
    }, on.computed = on.methods = function(t, e) {
        return e ? t ? { ...t,
            ...e
        } : e : t
    }, on.i18n = on.data = function(t, e, i) {
        return i ? rn(t, e, i) : e ? t ? function(i) {
            return rn(t, e, i)
        } : e : t
    };
    const un = /,(?![^(]*\))/;
    ...
    function fn(t, e = "update") {
        t._connected && t._updates.length && (t._queued || (t._queued = new Set, ni.read((() => {
            t._connected && function(t, e) {
                for (const {
                        read: i,
                        write: n,
                        events: s = []
                    ...
                    let o;
                    i && (o = i.call(t, t._data, e), o && w(o) && m(t._data, o)), n && !1 !== o && ni.write((() => {
                        t._connected && n.call(t, t._data, e)
                    }))
                }
            }(t, t._queued), delete t._queued
    ...
    function vn(t = {}) {
        return mn({
            handler: function(e, i) {
                ...
                for (const t of B(g(n) ? n(this) : n)) Ee('[loading="lazy"]', t).slice(0, s - 1).forEach((t => et(t, "loading")));
            ...
            handler(t) {
                ...
                qt(document, `${Qe} ${ii} scroll`, (t => {
                    ...
                    ("scroll" !== t.type && i && n && Math.abs(e.x - n) > 100 || s && Math.abs(e.y - s) > 100) && setTimeout((() => {
                        Vt(i, "swipe"), Vt(i, `swipe${function(t,e,i,n){return Math.abs(t-i)>=Math.abs(e-n)?t-i>0?"Left":"Right":e-n>0?"Up":"Down"}(e.x,e.y,n,s)}`)
                    }))
                }))
            },
            ...t
    ...
    var Sn = {
        ...
        data: {
            margin: "uc-margin-small-top",
            firstColumn: "uc-first-column"
        },
        observe: [gn({
            options: {
                childList: !0,
        ...
        update: {
            ...
            write({
                ...
                for (const e of t)
                    for (const i of e) lt(i, this.margin, t[0] !== e), lt(i, this.firstColumn, e[Xe ? e.length - 1 : 0] === i)
            },
            events: ["resize"]
        }
    };
    ...
    function En(t, e, i, n = 0) {
        const s = An(e, !0),
            ...
            l = a((async () => {
                nt(e, Cn), await Promise.all(Pn(e).map(((t, e) => new Promise((s => setTimeout((() => se.start(t, r, i / 2, "ease").then(s)), e * n)))))), st(e, Cn)
            })),
            h = a((async () => {
                const a = Oe(e);
                nt(e, Tn), t(), Qt(St(e), {
                ...
                const d = c.map((async (t, e) => {
                    ...
                    }(e * n), await se.start(t, o, i / 2, "ease")
                }));
                a !== h && d.push(se.start(e, {
                    height: h
                }, i / 2 + c.length * n, "ease")), await Promise.all(d).then((() => {
                    st(e, Tn), s === An(e) && (Qt(e, {
                        height: "",
                        alignContent: ""
                    }), Qt(l, {
    ...
    function Dn(t) {
        return Promise.all(St(t).filter(se.inProgress).map((t => new Promise((e => qt(t, "transitionend transitioncanceled", e))))))
    }

    function Pn(t) {
        return In(St(t)).flat().filter((t => ut(t)))
    }
    async function Mn(t, e, i) {
        await On();
        let n = St(e);
        const s = n.map((t => _n(t, !0))),
            o = { ...Qt(e, ["height", "padding"]),
                display: "block"
            };
        await Promise.all(n.concat(e).map(se.cancel)), t(), n = n.concat(St(e).filter((t => !d(n, t)))), await Promise.resolve(), ni.flush();
        const r = Q(e, "style"),
            a = Qt(e, ["height", "padding"]),
            [l, h] = function(t, e, i) {
                const n = e.map(((t, e) => !(!vt(t) || !(e in i)) && (i[e] ? ut(t) ? Bn(t) : {
                        opacity: 0
                    } : {
                        opacity: ut(t) ? 1 : 0
                    }))),
        ...
        try {
            await Promise.all(u), n.forEach(((t, i) => {
    ...
    var Nn = {
        ...
        methods: {
            animate(t, e = this.$el) {
                ...
                return ("fade" === i ? En : "delayed-fade" === i ? (...t) => En(...t, 40) : i ? Mn : () => (t(), Promise.resolve()))(t, e, this.duration).catch(R)
            }
        }
    };
    const zn = 9,
    ...
    var Un = {
        ...
        events: {
            ...
            handler(t) {
                "keydown" === t.type && t.keyCode !== Fn || t.target.closest("a,button") && (t.preventDefault(), this.apply(t.current))
            }
        },
        methods: {
            apply(t) {
            ...
            getState() {
                return this.toggles.filter((t => at(t, this.cls))).reduce(((t, e) => Xn(e, this.attrItem, t)), {
                    filter: {
                        "": ""
                    },
                    sort: []
            ...
            async setState(t, e = !0) {
                t = {
                    ...
                    sort: [],
                    ...t
                }, Vt(this.$el, "beforeFilter", [this, t]);
                for (const e of this.toggles) lt(e, this.cls, Jn(e, this.attrItem, t));
                await Promise.all(Ee(this.target, this.$el).map((i => {
                    const n = () => {
                        (function(t, e, i) {
                            const n = function({
                                filter: t
    ...
    function Xn(t, e, i) {
        ...
        return (n || A(o)) && (s ? n ? (delete i.filter[""], i.filter[s] = n) : (delete i.filter[s], (E(i.filter) || "" in i.filter) && (i.filter = {
            "": n || ""
        })) : i.filter = {
            "": n || ""
        }), A(o) || (i.sort = [o, r]), i
    ...
    function Kn(t) {
        const e = Lt(t, "touchstart", (e => {
            ...
            let i = Zt(e).y;
            const n = Lt(t, "touchmove", (e => {
                const n = Zt(e).y;
                n !== i && (i = n, Di(e.target).some((e => {
            ...
            qt(t, "scroll touchend touchcanel", n, {
                capture: !0
            })
        }));
        if (Zn) return e;
    ...
    var Qn = {
        ...
        ts = {
            ...
            computed: {
                ...
                hasTransition: ({
                    animation: t
                }) => ["slide", "reveal"].some((e => h(t[0], e)))
            },
            methods: {
                async toggleElement(t, e, i) {
                    try {
                        return await Promise.all(B(t).map((t => {
                            const n = I(e) ? e : !this.isToggled(t);
                            if (!Vt(t, "before" + (n ? "show" : "hide"), [this])) return Promise.reject();
                            const s = (g(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? is : ns : es)(t, n, this),
                ...
                isToggled(t = this.$el) {
                    return !!at(t = _(t), this.clsEnter) || !at(t, this.clsLeave) && (this.cls ? at(t, this.cls.split(" ")[0]) : ut(t))
                },
                _toggle(t, e) {
                    if (!t) return;
                    let i;
                    e = !!e, this.cls ? (i = d(this.cls, " ") || e !== at(t, this.cls), i && lt(t, this.cls, d(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden, i && (t.hidden = !e)), Ee("[autofocus]", t).some((t => ut(t) ? t.focus() || !0 : t.blur())), i && Vt(t, "toggled", [e, this])
                }
            }
        };
    ...
    async function is(t, e, {
        ...
        var a;
        const [l = "reveal", h = "top"] = (null == (a = i[0]) ? void 0 : a.split("-")) || [], c = [
            ["left", "right"],
            ["top", "bottom"]
        ], u = c[d(c[0], h) ? 0 : 1], f = u[1] === h, p = ["width", "height"][c.indexOf(u)], m = `margin-${u[0]}`, g = `margin-${h}`;
        let v = Pe(t)[p];
        const w = se.inProgress(t);
        await se.cancel(t), e && r(t, !0);
        const b = Object.fromEntries(["padding", "border", "width", "height", "minWidth", "minHeight", "overflowY", "overflowX", m, g].map((e => [e, t.style[e]]))),
            x = Pe(t),
            $ = M(Qt(t, m)),
            y = M(Qt(t, g)),
            S = x[p] + y;
        ...
        Qt(I, {
            ...
            height: x.height,
            width: x.width,
            ...Qt(t, ["overflow", "padding", "borderTop", "borderRight", "borderBottom", "borderLeft", "borderImage", g])
        }), Qt(t, {
            padding: 0,
            border: 0,
            minWidth: 0,
        ...
        f && (Qt(t, m, S - v + $), C[m] = e ? $ : S + $), !f ^ "reveal" === l && (Qt(I, m, -S + v), se.start(I, {
            [m]: e ? 0 : -S
        }, n, o));
        try {
    ...
    var os = {
        ...
        events: [{
            ...
            handler(t) {
                ...
                !i && n && kt(e) && !this.$el.contains(Te(n)) ? this.hide() : bt(e, this.selClose) && (t.preventDefault(), this.hide())
            }
        }, {
            name: "toggle",
            self: !0,
            ...
            handler(t) {
                ...
                !this.stack && ss.length ? (Promise.all(ss.map((t => t.hide()))).then(this.show), t.preventDefault()) : ss.push(this)
            }
        }, {
            name: "show",
            self: !0,
            handler() {
                ...
                const t = [this.overlay && as(this), this.overlay && Kn(this.$el), this.bgClose && ls(this), this.escClose && hs(this)];
                qt(this.$el, "hidden", (() => t.forEach((t => t && t()))), {
                    self: !0
            ...
            self: !0,
            handler() {
                d(ss, this) && ss.splice(ss.indexOf(this), 1), Qt(this.$el, "zIndex", ""), ss.some((t => t.clsPage === this.clsPage)) || st(document.documentElement, this.clsPage)
            }
        }],
        methods: {
            toggle() {
            ...
            show() {
                return this.container && vt(this.$el) !== this.container ? (me(this.container, this.$el), new Promise((t => requestAnimationFrame((() => this.show().then(t)))))) : this.toggleElement(this.$el, !0, rs)
            },
            hide() {
    ...
    function rs(t, e, {
        ...
        return new Promise(((s, o) => qt(t, "show hide", (() => {
            var r;
            null == (r = t._reject) || r.call(t), t._reject = o, n(t, e);
            const a = qt(i, "transitionstart", (() => {
                    qt(i, "transitionend transitioncancel", s, {
                        self: !0
                    }), clearTimeout(l)
                }), {
                    self: !0
    ...
    function ls(t) {
        return Lt(document, Ze, (({
            target: e
        }) => {
            H(ss) !== t || t.overlay && !t.$el.contains(e) || t.panel.contains(e) || qt(document, `${Qe} ${ii} scroll`, (({
                defaultPrevented: i,
                type: n,
                target: s
            }) => {
    ...
    var cs = {
        slide: {
            ...
            percent: t => ds(t),
            translate: (t, e) => [{
                transform: us(-100 * e * t)
            }, {
                transform: us(100 * e * (1 - t))
            }]
        }
    };
            ...
            methods: {
                startAutoplay() {
                    this.stopAutoplay(), this.interval = setInterval((() => {
                        this.stack.length || this.draggable && bt(this.$el, ":focus-within") && !bt(this.$el, ":focus") || this.pauseOnHover && bt(this.$el, ":hover") || this.show("next")
    ...
    var ys = {
        ...
        events: [{
            ...
            handler(t) {
                !this.draggable || this.parallax || !Gt(t) && function(t) {
                    return "none" !== Qt(t, "userSelect") && p(t.childNodes).some((t => 3 === t.nodeType && t.textContent.trim()))
                }(t.target) || t.target.closest(ft) || t.button > 0 || this.length < 2 || this.start(t)
            }
        }, {
            name: "dragstart",
            handler(t) {
        ...
        methods: {
            start() {
                this.drag = this.pos, this._transitioner ? (this.percent = this._transitioner.percent(), this.drag += this._transitioner.getDistance() * this.percent * this.dir, this._transitioner.cancel(), this._transitioner.translate(this.percent), this.dragging = !0, this.stack = []) : this.prevIndex = this.index, Lt(document, bs, this.move, vs), Lt(document, xs, this.end, ws), Qt(this.list, "userSelect", "none")
            },
            move(t) {
                const e = this.pos - this.drag;
                if (0 === e || this.prevPos === this.pos || !this.dragging && Math.abs(e) < this.threshold) return;
                this.dragging || Lt(this.list, "click", $s, vs), t.cancelable && t.preventDefault(), this.dragging = !0, this.dir = e < 0 ? 1 : -1;
                let {
                    slides: i,
                    prevIndex: n
                } = this, s = Math.abs(e), o = this.getIndex(n + this.dir), r = Ss.call(this, n, o);
                for (; o !== n && s > r;) this.drag -= r * this.dir, n = o, s -= r, o = this.getIndex(n + this.dir), r = Ss.call(this, n, o);
                this.percent = s / r;
                const a = i[n],
                    l = i[o],
                    h = this.index !== o,
                    c = n === o;
                let u;
                for (const t of [this.index, this.prevIndex]) d([o, n], t) || (Vt(i[t], "itemhidden", [this]), c && (u = !0, this.prevIndex = n));
                (this.index === n && this.prevIndex !== n || u) && Vt(i[this.index], "itemshown", [this]), h && (this.prevIndex = n, this.index = o, c || (Vt(a, "beforeitemhide", [this]), Vt(a, "itemhide", [this])), Vt(l, "beforeitemshow", [this]), Vt(l, "itemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), a, !c && l)
            },
            end() {
                ...
                setTimeout((() => Wt(this.list, "click", $s, vs))), Qt(this.list, {
                    userSelect: ""
        ...
        t._hasComputed && (function(t, e) {
            ...
            read: () => function(t, e) {
                for (const {
                        ...
                        handler: s,
                        immediate: o = !0
                    } of t._watches)(t._initial && o || n(e, i) && !N(e[i], t[i])) && s.call(t, t[i], e[i]);
                t._initial = !1
            }(t, Ts(t)),
            events: ["resize", "computed"]
        }), Es || (As = new Set, Es = new MutationObserver((() => {
    ...
    function Ds(t, e, i) {
        ...
        s = g(s) ? s.call(t, t) : s || t.$el, !(!s || f(s) && !s.length || h && !h.call(t)) && t._events.push(Lt(s, n, l ? k(l) ? l : l.call(t, t) : null, k(o) ? t[o] : o.bind(t), {
            passive: a,
            capture: r,
            self: c
        }))
    ...
    const Os = K(((t, e) => {
        const i = Object.keys(e),
            n = i.concat(t).map((t => [o(t), `data-${o(t)}`])).flat();
        return {
            attributes: i,
            filter: n
        }
    ...
    function zs(t) {
        t._connected || (function(t) {
            ...
            const {
                attributes: r,
                filter: l
            } = Os(n, s), h = new MutationObserver((s => {
                const o = Bs(e);
                s.some((({
                    attributeName: t
                }) => {
        ...
        }(t), Cs(t), Ns(t, "connected"), fn(t))
    }

    function Hs(t) {
        t._connected && (Ns(t, "beforeDisconnect"), function(t) {
        ...
        }(t), Ns(t, "disconnected"), t._connected = !1)
    }
    let Fs = 0;
    ...
    function js(t, e = {}) {
        e.data = function({
                ...
                return t
            }(e, t.constructor.options), t.$options = hn(t.constructor.options, e, t), t.$props = {}, t._uid = Fs++,
            function(t) {
                const {
                    data: e = {}
                } = t.$options;
            ...
            function(t) {
                ...
                if (t._computed = {}, e)
                    for (const i in e) ks(t, i, e[i])
            }(t), Ns(t, "created"), e.el && t.$mount(e.el)
    }
    const Ls = function(t) {
        js(this, t)
    };
    ...
    function Rs(t, e) {
        ...
        return s.id = n, s.name = t, null == (i = s.install) || i.call(s, Ls, s, t), Ls._initialized && !s.functional && requestAnimationFrame((() => Us(t, `[${n}],[data-${n}]`))), Vs[n] = s
    }
    ...
    var Qs = {
                ...
                navItems(t) {
                    for (const e of t) {
                        ...
                        if (T(t)) {
                            const e = P(t),
                                o = this.slides[e];
                            o && (o.id || (o.id = Ks(this, o)), s = o.id), n = this.t("slideX", M(t) + 1), Q(i, "role", "tab")
                        } else this.list && (this.list.id || (this.list.id = Ks(this, this.list)), s = this.list.id), n = this.t(t);
                        Q(i, {
                            "aria-controls": s,
                            "aria-label": Q(i, "aria-label") || n
                        })
                    }
                },
                slides(t) {
            ...
            events: [{
                ...
                handler(t) {
                    t.target.closest("a,button") && ("click" === t.type || t.keyCode === Fn) && (t.preventDefault(), this.show(it(t.current, this.attrItem)))
                }
            }, {
                name: "itemshow",
                handler: "updateNav"
            ...
            methods: {
                updateNav() {
                    ...
                    for (const e of this.navItems) {
                        ...
                        if (T(i)) {
                            const s = P(i) === t;
                            lt(e, this.clsActive, s), lt(n, "uc-disabled", this.parallax), Q(n, {
                                "aria-selected": s,
                                tabindex: s && !this.parallax ? null : -1
                            }), s && n && bt(vt(e), ":focus-within") && n.focus()
                        } else lt(e, "uc-invisible", this.finite && ("previous" === i && 0 === t || "next" === i && t >= this.maxIndex))
                    }
                }
            }
        },
            ...
            methods: {
                show(t, e = !1) {
                    ...
                    if (this.dir = function(t, e) {
                        ...
                        }(t, r), this.prevIndex = r, this.index = l, a && !Vt(a, "beforeitemhide", [this]) || !Vt(h, "beforeitemshow", [this, a])) return this.index = this.prevIndex, void o();
                    const c = this._show(a, h, e).then((() => {
                        a && Vt(a, "itemhidden", [this]), Vt(h, "itemshown", [this]), n.shift(), this._transitioner = null, requestAnimationFrame((() => n.length && this.show(n.shift(), !0)))
                    }));
            ...
            data: {
                ...
                Transitioner: function(t, e, i, {
                    ...
                    return {
                        ...
                        show(n, o = 0, r) {
                            const a = r ? "linear" : s;
                            return n -= Math.round(n * V(o, -1, 1)), this.translate(o), ps(e, "itemin", {
                                percent: o,
                                duration: n,
                                timing: a,
                                dir: i
                                ...
                                h || (h = i), Promise.all([se.start(e, l[1], n, a), se.start(t, l[0], n, a)]).then((() => {
                                    this.reset(), h()
                                }), R)
                            }))
                        },
                        ...
                        translate(n) {
                            this.reset();
                            const s = r(n, i);
                            Qt(e, s[1]), Qt(t, s[0]), ps(e, "itemtranslatein", {
                                percent: n,
                                dir: i
                            }), ps(t, "itemtranslateout", {
                                percent: 1 - n,
                                dir: i
                            })
                        },
        ...
        so = {
            ...
            events: [{
                ...
                handler({
                    ...
                    let e = -1;
                    t === Wn ? e = "previous" : t === Vn ? e = "next" : t === Ln ? e = 0 : t === jn && (e = "last"), ~e && this.show(e)
                }
            }, {
                name: "beforeitemshow",
                handler(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleElement(this.$el, !0, !1), this.animation = no.scale, st(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler() {
                ...
                async handler(t, e) {
                    ...
                    } else if ("iframe" === n || i.match(/\.(html|php)($|\?)/i)) this.setItem(e, oo("iframe", {
                        src: i,
                        allowfullscreen: "",
                        class: "uc-lightbox-iframe",
                        ...r
                    }));
                    else if (a = i.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) this.setItem(e, oo("iframe", {
            ...
            methods: {
                ...
                showControls() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), nt(this.$el, "uc-active", "uc-transition-active")
                },
                hideControls() {
        ...
        methods: {
            show(t) {
                ...
                return this.panel = this.panel || this.$create("lightboxPanel", { ...this.$props,
                    items: e
                }), Lt(this.panel.$el, "hidden", (() => this.panel = null)), this.panel.show(t)
            },
            hide() {
                var t;
    ...
    var lo = {
        ...
        created() {
            const t = `${this.clsContainer}-${this.pos}`,
                ...
                i = Te(`.${t}[${e}]`, this.container) || me(this.container, `<div class="${this.clsContainer} ${t}" ${e}></div>`);
            this.$mount(me(i, `<div class="${this.clsMsg}${this.status?` ${this.clsMsg}-${this.status}`:""}" role="alert"> <a href class="${this.clsClose}" data-uc-close></a> <div>${this.message}</div> </div>`))
        },
        async connected() {
            const t = M(Qt(this.$el, this.marginProp));
            await se.start(Qt(this.$el, this.startProps), {
                opacity: 1,
                [this.marginProp]: t
        ...
        methods: {
            async close(t) {
                this.timer && clearTimeout(this.timer), t || await se.start(this.$el, this.startProps), (t => {
                    const e = vt(t);
    ...
    function uo(t) {
        return Math.ceil(Math.max(0, ...Ee("[stroke]", t).map((t => {
            try {
    ...
    const fo = {
            ...
            opacity: function(t, e, i) {
                return 1 === i.length && i.unshift(Ao(e, t, "")), i = Io(i), (e, n) => {
                    e[t] = Co(i, n)
                }
            },
            stroke: function(t, e, i) {
                ...
                const n = Eo(i),
                    s = uo(e);
                return (i = Io(i.reverse(), (t => (t = M(t), "%" === n ? t * s / 100 : t)))).some((([t]) => t)) ? (Qt(e, "strokeDasharray", s), (t, e) => {
    ...
    function go(t, e, i) {
        ...
        return "x" === t || "y" === t ? (t = `translate${l(t)}`, n = t => M(M(t).toFixed("px" === s ? 0 : 6))) : "scale" === t && (s = "", n = t => {
            var i;
            return Eo([t]) ? je(t, "width", e, !0) / e["offset" + (null != (i = t.endsWith) && i.call(t, "vh") ? "Height" : "Width")] : M(t)
        }), 1 === i.length && i.unshift("scale" === t ? 1 : 0), i = Io(i, n), (e, n) => {
            e.transform = `${e.transform||""} ${t}(${Co(i,n)}${s})`
        }
    }

    function vo(t, e, i) {
        return 1 === i.length && i.unshift(Ao(e, t, "")), i = Io(i, (t => function(t, e) {
            return Ao(t, "color", e).split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(M)
        }(e, t))), (e, n) => {
            const [s, o, r] = ko(i, n), a = s.map(((t, e) => (t += r * (o[e] - t), 3 === e ? M(t) : parseInt(t, 10)))).join(",");
            e[t] = `rgba(${a})`
        }
    }
    ...
    function bo(t, e, i, n) {
        ...
        if ("cover" === Ao(e, "backgroundSize", "")) return function(t, e, i, n) {
            const s = function(t) {
    ...
    function Io(t, e = M) {
        ...
        for (let o = 0; o < n; o++) {
            ...
            if (r = e(r), a = a ? M(a) / 100 : null, 0 === o ? null === a ? a = 0 : a && i.push([r, 0]) : o === n - 1 && (null === a ? a = 1 : 1 !== a && (i.push([r, a]), a = 1)), i.push([r, a]), null === a) s++;
            else if (s) {
                const t = i[o - s - 1][1],
                    e = (a - t) / (s + 1);
        ...
        update: {
            write() {
                ...
                const t = this.parallaxTarget,
                    e = Po(Ai(t, je(this.parallaxStart, "height", t, !0), je(this.parallaxEnd, "height", t, !0)), this.parallaxEasing),
                    ...
                    r = this.slides[s],
                    {
                        ...
                        function s(i) {
                            at(i, n) && (r(i), a(i)), at(i, e) || (Vt(i, "beforeitemshow", [t]), Vt(i, "itemshow", [t]))
                        }
                        ...
                        function r(r) {
                            at(r, e) || s(r), at(r, i) && o(r), at(r, n) || (Vt(r, "beforeitemhide", [t]), Vt(r, "itemhide", [t]))
                        }
                ...
                if (~this.prevIndex)
                    for (const t of new Set([this.index, this.prevIndex])) d([s, i], t) || (h(this.slides[t]), c(this.slides[t]));
                const u = this.prevIndex !== i || this.index !== s;
                this.dir = 1, this.prevIndex = i, this.index = s, o !== r && h(o), a(r), u && l(o), this._translate(o === r ? 1 : n, o, r)
            },
            events: ["scroll", "resize"]
        },
        methods: {
    ...
    var qo = {
        ...
        data: {
            ...
            Transitioner: function(t, e, i, {
                ...
                return {
                    ...
                    show(e, n = 0, r) {
                        const h = r ? "linear" : s;
                        return e -= Math.round(e * V(n, -1, 1)), this.translate(n), n = t ? n : V(n, 0, 1), Wo(this.getItemIn(), "itemin", {
                            percent: n,
                            duration: e,
                            timing: h,
                            dir: i
                        }), t && Wo(this.getItemIn(!0), "itemout", {
                            percent: 1 - n,
                            duration: e,
                            timing: h,
                            dir: i
                    ...
                    translate(n) {
                        ...
                        for (const s of St(o)) {
                            const a = d(r, s),
                                c = s === l,
                                u = s === h;
                            Wo(s, "itemtranslate" + (c || !u && (a || i * (Xe ? -1 : 1) == -1 ^ jo(s, o) > jo(t || e)) ? "in" : "out"), {
                                dir: i,
                                percent: u ? 1 - n : c ? n : a ? 1 : 0
                            })
                        }
                    },
        ...
        computed: {
            finite({
                ...
                return t || function(t, e) {
                    ...
                    if (!e) return Math.ceil(Fo(t)) < Math.trunc(i + function(t) {
                    ...
                    for (const t in n) {
                        ...
                        if (Math.trunc(r) > L(n.filter((t => !o.has(t))), (t => Pe(t).width))) return !0
                    }
                    return !1
            ...
            sets({
                ...
                for (let t = 0; t < this.length; t++) {
                    ...
                    e + s > n && (e = 0), this.center ? e < n / 2 && e + s + Pe(this.slides[Z(+t + 1, this.slides)]).width / 2 > n / 2 && (i.push(+t), e = n / 2 - s / 2) : 0 === e && i.push(Math.min(+t, this.maxIndex)), e += s
                }
        ...
        events: {
            ...
            itemshow() {
                ~this.prevIndex && nt(this._getTransitioner().getItemIn(), this.clsActive), this.updateActiveClasses(this.prevIndex)
            },
            itemshown() {
        ...
        methods: {
            ...
            updateActiveClasses(t = this.index) {
                ...
                for (const t of this.slides) {
                    ...
                    for (const e of Ee(mt, t)) n(e, "_tabindex") || (e._tabindex = Q(e, "tabindex")), Q(e, "tabindex", s ? e._tabindex : -1)
                }
            },
            getValidIndex(t = this.index, e = this.prevIndex) {
            ...
            getAdjacentSlides() {
                const {
                    width: t
                } = Pe(this.list), e = -t, i = 2 * t, n = Pe(this.slides[this.index]).width, s = this.center ? t / 2 - n / 2 : 0, o = new Set;
                for (const t of [-1, 1]) {
                    let r = s + (t > 0 ? n : 0),
                        a = 0;
                    do {
            ...
            getIndexAt(t) {
                let e = -1;
                let i = t * (this.center ? Fo(this.list) - (Pe(this.slides[0]).width / 2 + Pe(H(this.slides)).width / 2) : Fo(this.list, this.maxIndex)),
                    n = 0;
                do {
                    ...
                    const h = this.getSortable(o),
                        c = function(t, e, i, n, s, o) {
                            ...
                            if (!o) return function(t, e) {
                                ...
                                return i && be(e), s
                            }(t, i) || s < r.top + r.height / 2 ? e : e.nextElementSibling;
                            const a = Pe(i),
            ...
            methods: {
                init(t) {
                    const {
                        ...
                        button: i,
                        defaultPrevented: n
                    } = t, [s] = this.items.filter((t => t.contains(e)));
                    !s || n || i > 0 || pt(e) || e.closest(`.${this.clsNoDrag}`) || this.handle && !e.closest(this.handle) || (t.preventDefault(), this.touched = new Set([this]), this.placeholder = s, this.origin = {
                        target: e,
                        index: It(s),
                        ...this.pos
                    }, Lt(document, Ke, this.move), Lt(document, Qe, this.end), this.threshold || this.start(t))
                },
                start(t) {
                    this.drag = function(t, e) {
                        ...
                        return me(t, i), Qt(i, "margin", "0", "important"), Qt(i, {
                            boxSizing: "border-box",
                            width: e.offsetWidth,
                            height: e.offsetHeight,
                            padding: Qt(e, "padding")
                        }), Oe(i.firstElementChild, Oe(e.firstElementChild)), i
                    ...
                    m(this.origin, {
                        ...
                        }), nt(this.drag, this.clsDrag, this.clsCustom), nt(this.placeholder, this.clsPlaceholder), nt(this.items, this.clsItem), nt(document.documentElement, this.clsDragState), Vt(this.$el, "start", [this, this.placeholder]),
                        function(t) {
                            let e = Date.now();
                            Go = setInterval((() => {
                                let {
                                ...
                                e = Date.now(), Di(document.elementFromPoint(i, t.y)).reverse().some((t => {
                                    let {
                                        scrollTop: e,
                                        scrollHeight: i
                                    } = t;
                ...
                move(t) {
                    ...
                    this === t ? this.origin.index !== It(this.placeholder) && Vt(this.$el, "moved", [this, this.placeholder]) : (Vt(t.$el, "added", [t, this.placeholder]), Vt(this.$el, "removed", [this, this.placeholder])), Vt(this.$el, "stop", [this, this.placeholder]), be(this.drag), this.drag = null;
                    for (const {
                            clsPlaceholder: t,
                            clsItem: e
                        } of this.touched)
    ...
    var Ko = {
        ...
        connected() {
            this.pos = this.$props.pos.split("-").concat("center").slice(0, 2), [this.dir, this.align] = this.pos, this.axis = d(["top", "bottom"], this.dir) ? "y" : "x"
        },
        methods: {
            positionAt(t, e, i) {
                ...
                const s = [this.flip && "flip", this.shift && "shift"],
                    o = {
                        element: [this.inset ? this.dir : Fe(this.dir), this.align],
            ...
            getPositionOffset(t = this.$el) {
                return je(!1 === this.offset ? Qt(t, "--uc-position-offset") : this.offset, "x" === this.axis ? "width" : "height", t) * (d(["left", "top"], this.dir) ? -1 : 1) * (this.inset ? -1 : 1)
            },
            getShiftOffset(t = this.$el) {
                return "center" === this.align ? 0 : je(Qt(t, "--uc-position-shift-offset"), "y" === this.axis ? "width" : "height", t) * (d(["left", "top"], this.align) ? 1 : -1)
            },
    ...
    var Qo = {
        ...
        data: {
            pos: "top",
            animation: ["uc-animation-scale-up"],
            duration: 100,
            cls: "uc-active"
        },
        connected() {
        ...
        methods: {
            show() {
                ...
                Q(this.$el, {
                    title: null,
                    "aria-describedby": s
                }), clearTimeout(this.showTimer), this.showTimer = setTimeout((() => this._show(e, s)), t)
            },
            async hide() {
                var t;
                bt(this.$el, "input:focus") || (clearTimeout(this.showTimer), this.isToggled(this.tooltip || null) && await this.toggleElement(this.tooltip, !1, !1), null == (t = this.reset) || t.call(this), be(this.tooltip), this.tooltip = null)
            },
            async _show(t, e) {
                this.tooltip = me(this.container, `<div id="${e}" class="uc-${this.$options.name}" role="tooltip"> <div class="uc-${this.$options.name}-inner">${t}</div> </div>`), Lt(this.tooltip, "toggled", ((t, e) => {
                    if (!e) return;
                    ...
                    const o = [qt(document, `keydown ${Ze}`, this.hide, !1, (t => t.type === Ze && !this.$el.contains(t.target) || "keydown" === t.type && t.keyCode === Hn)), Lt([document, ...Mi(this.$el)], "scroll", i, {
                        passive: !0
                    })];
                    qt(this.tooltip, "hide", (() => o.forEach((t => t()))), {
                        self: !0
                    })
                    ...
                    i = async t => {
                        ...
                        try {
                            ...
                            function(t, e) {
                                ...
                                return Promise.resolve().then((() => i.beforeSend(i))).then((() => function(t, e) {
                                    return new Promise(((i, n) => {
                                        ...
                                        Lt(s, "load", (() => {
                                            0 === s.status || s.status >= 200 && s.status < 300 || 304 === s.status ? i(s) : n(m(Error(s.statusText), {
                                                xhr: s,
                                                status: s.status
                                            }))
                                        })), Lt(s, "error", (() => n(m(Error("Network Error"), {
                                            xhr: s
                                        })))), Lt(s, "timeout", (() => n(m(Error("Network Timeout"), {
                                            xhr: s
                                        })))), s.send(e.data)
                                    }))
                                }(t, i)))
    ...
    var nr, sr = {
            connected() {
                var t;
                this.registerObserver(ui((null == (t = this.$options.resizeTargets) ? void 0 : t.call(this)) || this.$el, (() => this.$emit("resize"))))
            }
        },
        or = {
            mixins: [en, ho, sr],
            props: { ...Object.fromEntries(["duration", "x", "y", "translateX", "translateY", "color", "background"].map((t => [t, null]))),
                y: "list"
            },
            setup(t) {
                const e = t.x,
            ...
            update: {
                ...
                write({
                    ...
                    t ? "reset" in this.animation && "function" == typeof this.animation.reset && this.animation.reset() : this.animation.restart()
                },
                events: ["resize"]
            }
        },
    ...
    function ar(t) {
        Vt(document, "uikit:init", t), document.body && Ce(document.body, cr), new MutationObserver((t => t.forEach(lr))).observe(document, {
            subtree: !0,
            childList: !0
        }), new MutationObserver((t => t.forEach(hr))).observe(document, {
            subtree: !0,
            attributes: !0
        }), t._initialized = !0
    }
    ...
    function ur(t) {
        ...
        let e;
        t.component = Rs, t.getComponents = Ys, t.getComponent = Xs, t.update = Js, t.use = function(t) {
            ...
            return (i.prototype = Object.create(e.prototype)).constructor = i, i.options = hn(e.options, t), i.super = e, i.extend = e.extend, i
    ...
    })(Ls), (nr = Ls).prototype.$mount = function(t) {
        const e = this;
        (function(t, e) {
            t[qs] || (t[qs] = {}), t[qs][e.$options.name] = e
        })(t, e), e.$options.el = t, document.contains(t) && zs(e)
    ...
    }, nr.prototype.$create = Us, nr.prototype.$emit = function(t) {
        fn(this, t)
    }, nr.prototype.$update = function(t = this.$el, e) {
        Js(t, e)
    }, nr.prototype.$reset = function() {
        Hs(this), zs(this)
    }, nr.prototype.$getComponent = Xs, Object.defineProperties(nr.prototype, {
        $el: {
            get() {
    ...
    var fr = {
        ...
        watch: {
            ...
            contents(t) {
                for (const e of t) {
                    const t = at(this.items.find((t => t.contains(e))), this.clsOpen);
                    pr(e, !t)
                }
                this.$emit()
            }
        ...
        events: [{
            ...
            async handler(t) {
                var e;
                "keydown" === t.type && t.keyCode !== Fn || (t.preventDefault(), null == (e = this._off) || e.call(this), this._off = function(t) {
                    const e = Pi(t, !0);
                    let i;
                    return function n() {
                ...
                }(t.target), await this.toggle(It(this.toggles, t.current)), this._off())
            }
        }, {
            name: "shown hidden",
            self: !0,
        ...
        methods: {
            toggle(t, e) {
                ...
                if (!this.multiple && !d(n, i[0]) && (i = i.concat(n)), !(!this.collapsible && n.length < 2 && d(n, t))) return Promise.all(i.map((t => this.toggleElement(t, !d(n, t), ((t, i) => {
                    if (lt(t, this.clsOpen, i), !1 !== e && this.animation) return async function(t, e, {
                        content: i,
                        duration: n,
                        velocity: s,
                        transition: o
                        ...
                        var r;
                        i = (null == (r = t._wrapper) ? void 0 : r.firstElementChild) || Te(i, t), t._wrapper || (t._wrapper = xe(i, "<div>"));
                        const a = t._wrapper;
                        ...
                        const h = L(["marginTop", "marginBottom"], (t => Qt(i, t))) + Pe(i).height,
                            c = l / h;
                        n = (s * h + n) * (e ? 1 - c : c), Qt(a, "height", l), await se.start(a, {
                            height: e ? h : 0
                        }, n, o), ye(i), delete t._wrapper, e || pr(i, !0)
                    }(t, i, this);
    ...
    function gr(t, e, {
        ...
        return Qt(t, "height", o), se.start(t, {
            height: 0,
            marginTop: 0,
            marginBottom: 0,
            paddingTop: 0,
    ...
    var vr = {
            ...
            connected() {
                "inview" === this.autoplay && !tt(this.$el, "preload") && (this.$el.preload = "none"), de(this.$el, "iframe") && !tt(this.$el, "allow") && (this.$el.allow = "autoplay"), this.automute && wi(this.$el)
            },
            observe: [mn({
                filter: ({
                    $el: t,
    ...
    function br(t) {
        for (; t = vt(t);)
            if ("static" !== Qt(t, "position")) return t
    }
    ...
    var yr = {
        ...
        computed: {
            boundary: ({
                ...
                boundaryX: e,
                boundaryY: i
            }, n) => [Tt(e || t, n) || window, Tt(i || t, n) || window],
            target({
                target: t,
                targetX: e,
                targetY: i
            }, n) {
                return e || (e = t || this.targetEl), i || (i = t || this.targetEl), [!0 === e ? window : Tt(e, n), !0 === i ? window : Tt(i, n)]
            }
        },
        created() {
            this.tracker = new hi
        ...
        connected() {
            nt(this.$el, "uc-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = function(t) {
                const {
                    $el: e
                } = t.$create("toggle", Tt(t.toggle, t.$el), {
                    target: t.$el,
                    mode: t.mode
                });
                return Q(e, "aria-haspopup", !0), e
            }(this)), this._style = q(this.$el.style, ["width", "height"])
        },
        disconnected() {
        ...
        events: [{
            ...
            handler() {
                ...
                const t = [Sr(this), kr(this), Tr(this), this.autoUpdate && Ir(this), this.closeOnScroll && Cr(this)];
                qt(this.$el, "hide", (() => t.forEach((t => t && t()))), {
                    self: !0
                }), this.bgScroll || qt(this.$el, "hidden", Kn(this.$el), {
                    self: !0
                })
            }
        }, {
            ...
            handler({
                ...
                this.$el === t ? ($r = this.isActive() ? null : $r, this.tracker.cancel(), Q(this.targetEl, "aria-expanded", null)) : $r = null === $r && this.$el.contains(t) && this.isToggled() ? this : $r
            }
        }],
        update: {
            write() {
        ...
        methods: {
            show(t = this.targetEl, e = !0) {
                if (this.isToggled() && t && this.targetEl && t !== this.targetEl && this.hide(!1, !1), this.targetEl = t, this.clearTimers(), !this.isActive()) {
                    if ($r) {
                        if (e && $r.isDelaying) return void(this.showTimer = setTimeout((() => bt(t, ":hover") && this.show()), 10));
                        let i;
                        for (; $r && i !== $r && !$r.$el.contains(this.$el);) i = $r, $r.hide(!1, !1)
                    }
                    this.container && vt(this.$el) !== this.container && me(this.container, this.$el), this.showTimer = setTimeout((() => this.toggleElement(this.$el, !0)), e && this.delayShow || 0)
                }
            },
            hide(t = !0, e = !0) {
                const i = () => this.toggleElement(this.$el, !1, this.animateOut && e);
                this.clearTimers(), this.isDelayedHide = t, this.isDelaying = function(t) {
                    const e = [];
                    return Ce(t, (t => "static" !== Qt(t, "position") && e.push(t))), e
                }(this.$el).some((t => this.tracker.movesTo(t))), t && this.isDelaying ? this.hideTimer = setTimeout(this.hide, 50) : t && this.delayHide ? this.hideTimer = setTimeout(i, this.delayHide) : i()
            },
            clearTimers() {
            ...
            position() {
                ...
                const t = this.target.map((t => function(t, e) {
                ...
                for (const [n, [s, o]] of i) this.axis !== s && d([s, !0], this.stretch) && Qt(this.$el, {
                    [o]: Math.min(Me(this.boundary[n])[o], t[n][o] - 2 * e),
                    [`overflow-${s}`]: "auto"
                });
                const n = t[0].width - 2 * e;
                this.$el.hidden = !1, Qt(this.$el, "maxWidth", ""), this.$el.offsetWidth > n && nt(this.$el, "uc-drop-stack"), Qt(this.$el, "maxWidth", n), this.positionAt(this.$el, this.target, this.boundary);
                for (const [n, [s, o, r, a]] of i)
                    if (this.axis === s && d([s, !0], this.stretch)) {
                        const i = Math.abs(this.getPositionOffset()),
                            ...
                            h = Me(this.$el);
                        Qt(this.$el, {
                            [o]: (l[r] > h[r] ? l[this.inset ? a : r] - Math.max(Me(this.boundary[n])[r], t[n][r] + e) : Math.min(Me(this.boundary[n])[a], t[n][a] - e) - l[this.inset ? r : a]) - i,
                            [`overflow-${s}`]: "auto"
    ...
    function Ir(t, e = () => t.$emit()) {
        return Lt([document, ...Mi(t.$el)], "scroll", e, {
            passive: !0
        })
    }
    ...
    function Tr(t) {
        return Lt(document, Ze, (({
            ...
            t.$el.contains(e) || qt(document, `${Qe} ${ii} scroll`, (({
                defaultPrevented: i,
                type: n,
                target: s
            }) => {
    ...
    var Er = {
        ...
        computed: {
            ...
            dropbar({
                ...
                return t ? (t = this._dropbar || Tt(t, this.$el) || Te(`+ .${this.clsDropbar}`, this.$el)) || (this._dropbar = Te("<div></div>")) : null
            },
            dropContainer(t, e) {
        ...
        events: [{
            ...
            handler(t) {
                ...
                n === Rn && (null == s ? void 0 : s.targetEl) === i && (t.preventDefault(), null == (e = Te(mt, s.$el)) || e.focus()), Ar(t, this.items, s)
            }
        }, {
            name: "keydown",
            el() {
            ...
            handler(t) {
                ...
                let o = -1;
                if (n === Ln ? o = 0 : n === jn ? o = "last" : n === qn ? o = "previous" : n === Rn ? o = "next" : n === Hn && (null == (e = s.targetEl) || e.focus()), ~o) {
                    t.preventDefault();
                    const e = Ee(mt, i);
                    e[Z(o, e, u(e, (t => bt(t, ":focus"))))].focus()
                }
                Ar(t, this.items, s)
            }
        }, {
            ...
            handler({
                ...
                this.isDropbarDrop(t) && (this.dropbar.previousElementSibling !== this.dropbarAnchor && ve(this.dropbarAnchor, this.dropbar), nt(t, `${this.clsDrop}-dropbar`))
            }
        }, {
            name: "show",
            el() {
            ...
            handler({
                ...
                const e = this.getDropdown(t),
                    i = () => {
                        const i = Math.max(...yt(t, `.${this.clsDrop}`).concat(t).map((t => Me(t).bottom)));
                        Me(this.dropbar, {
            ...
            handler(t) {
                const e = this.getActive();
                bt(this.dropbar, ":hover") && e.$el === t.target && this.isDropbarDrop(e.$el) && d(e.mode, "hover") && e.isDelayedHide && !this.items.some((t => e.targetEl !== t && bt(t, ":focus"))) && t.preventDefault()
            }
        }, {
            name: "hide",
            el() {
        ...
        methods: {
            ...
            async transitionTo(t, e) {
                ...
                Qt(e, "clipPath", `polygon(0 0,100% 0,100% ${n}px,0 ${n}px)`), Oe(i, n), await Promise.all([se.start(i, {
                    height: t
                }, this.duration), se.start(e, {
                    clipPath: `polygon(0 0,100% 0,100% ${t}px,0 ${t}px)`
                }, this.duration).finally((() => Qt(e, {
                    clipPath: "",
                    transitionDelay: ""
                })))]).catch(R)
            },
    ...
    function Ar(t, e, i) {
        ...
        let l = -1;
        a === Ln ? l = 0 : a === jn ? l = "last" : a === Wn ? l = "previous" : a === Vn ? l = "next" : a === zn && (null == (n = i.targetEl) || n.focus(), null == (s = i.hide) || s.call(i, !1)), ~l && (t.preventDefault(), null == (o = i.hide) || o.call(i, !1), e[Z(l, e, e.indexOf(i.targetEl || r))].focus())
    }
    var Dr = {
            mixins: [en],
            args: "target",
            ...
            update() {
                ...
                const s = pt(e) ? "value" : "textContent",
                    o = e[s],
                    r = null != (t = i.files) && t[0] ? i.files[0].name : bt(i, "select") && (n = Ee("option", i).filter((t => t.selected))[0]) ? n.textContent : i.value;
                o !== r && (e[s] = r)
            },
            events: [{
                name: "change",
        ...
        Pr = {
            ...
            update: [{
                ...
                read(t) {
                    ...
                    if (n = Math.max(0, je(n)), !(i || n || s) || Mr(e) || e[0].some(((t, i) => e.some((e => e[i] && e[i].offsetWidth !== t.offsetWidth))))) return t.translates = t.scrollColumns = !1;
                    let r, a, l = function(t, e) {
                        ...
                        for (let a of t) {
                            ...
                            for (const l in a) {
                                const {
                                    offsetWidth: h,
                                    offsetHeight: c
                                } = a[l], d = i ? l : o.indexOf(Math.min(...o));
                                _r(n, d, a[l]), _r(s, d, [(d - l) * h * (Xe ? -1 : 1), o[d] - r]), o[d] += c + e, t = Math.max(t, c)
                            }
                            r += t + e
                        }
                        return [n, s]
                    }(e, l, "next" === i) : r = function(t) {
                        const e = [];
                        for (const i of t)
                            for (const t in i) _r(e, t, i[t]);
                        return e
                    }(e);
                    const h = r.map((t => L(t, "offsetHeight") + l * (t.length - 1))),
                        c = Math.max(0, ...h);
                    let d, u, f;
                    return (n || s) && (d = h.map(((t, e) => s ? c - t + n : n / (e % 2 || 8))), s || (n = Math.max(...h.map(((t, e) => t + d[e] - c)))), u = je(this.parallaxStart, "height", this.$el, !0), f = je(this.parallaxEnd, "height", this.$el, !0)), {
                        columns: r,
                        translates: a,
                        scrollColumns: d,
                        parallaxStart: u,
                ...
                write({
                    ...
                    !e && !n || t.forEach(((t, s) => t.forEach(((t, o) => {
                        let [r, a] = n && n[s][o] || [0, 0];
    ...
    var Br = {
        ...
        observe: pn({
            target: ({
                $el: t,
                elements: e
            }) => e.reduce(((t, e) => t.concat(e, ...e.children)), [t])
        }),
        events: {
            name: "loadingdone",
            el: () => document.fonts,
        ...
        update: {
            read() {
                return {
                    rows: (this.row ? In(this.elements) : [this.elements]).map(Or)
                }
            },
            write({
                rows: t
                ...
                for (const {
                        heights: e,
                        elements: i
                    } of t) i.forEach(((t, i) => Qt(t, "minHeight", e[i])))
            },
            events: ["resize"]
        }
    };
    ...
    var zr = {
            ...
            update: {
                read() {
                    ...
                    if (t = "calc(" + (r ? "100vh" : `${o}px`), this.expand) {
                        ...
                        if (this.offsetTop)
                            if (r) {
                                const e = Be(!0 === this.offsetTop ? this.$el : Tt(this.offsetTop, this.$el))[0] - Be(s)[0];
                                t += e > 0 && e < o / 2 ? ` - ${e}px` : ""
                            } else t += ` - ${Qt(s,"paddingTop")}`;
                        !0 === this.offsetBottom ? t += ` - ${Pe(this.$el.nextElementSibling).height}px` : T(this.offsetBottom) ? t += ` - ${this.offsetBottom}vh` : this.offsetBottom && c(this.offsetBottom, "px") ? t += ` - ${M(this.offsetBottom)}px` : k(this.offsetBottom) && (t += ` - ${Pe(Tt(this.offsetBottom,this.$el)).height}px`)
                    }
                    return t += (e ? ` - ${e}px` : "") + ")", {
                        minHeight: t
                    }
        ...
        Fr = '<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',
        jr = {
            args: "src",
            props: {
                width: Number,
    ...
    function Wr(t, e) {
        ...
        const s = Q(e, "viewBox");
        s && !n.some((t => t)) && (n = s.split(" ").slice(2)), n.forEach(((e, n) => Q(t, i[n], M(e) * this.ratio || null)))
    }
    const qr = {
            ...
            "close-icon": '<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',
            "close-large": '<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',
            ...
            "search-icon": Fr,
            "search-large": '<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',
            "search-navbar": '<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',
        ...
        Vr = {
            install: function(t) {
                t.icon.add = (e, i) => {
                    ...
                    F(n, ((t, e) => {
                        qr[e] = t, delete na[e]
                    })), t._initialized && Ce(document.body, (e => F(t.getComponents(e), (t => {
            ...
            methods: {
                async getSvg() {
                    const t = function(t) {
                        return t = sa[t] || t, qr[t] ? (na[t] || (na[t] = Te((qr[function(t) {
                            return Xe ? z(z(t, "left", "right"), "previous", "next") : t
                        }(t)] || qr[t]).trim())), na[t].cloneNode(!0)) : null
                    }(this.icon);
        ...
        Yr = {
            ...
            beforeConnect() {
                ...
                if (this.icon = t ? "search-toggle-icon" : at(this.$el, "uc-search-icon") && xt(this.$el, ".uc-search-large") ? "search-large" : xt(this.$el, ".uc-search-navbar") ? "search-navbar" : this.$props.icon, !tt(this.$el, "aria-label"))
                    if (t) {
    ...
    var oa = {
        ...
        methods: {
            load() {
                ...
                const t = ha(this.$el) ? this.$el : function(t, e, i) {
                    const n = new Image;
                    return function(t, e) {
                        if (e = function(t) {
                                if (!t) return [];
    ...
    function ra(t, e) {
        ...
        } else e && !d(t.style.backgroundImage, e) && (Qt(t, "backgroundImage", `url(${jt(e)})`), Vt(t, Rt("load", !1)))
    }
    ...
    var ca = {
        ...
        observe: [gn({
            ...
            observe: (t, e) => {
                const i = ui([...t, document.documentElement], e),
                    n = [Lt(document, "scroll itemshown itemhidden", e, {
                        passive: !0,
                        capture: !0
                    }), Lt(document, "show hide transitionstart", (t => (e(), i.observe(t.target)))), Lt(document, "shown hidden transitionend transitioncancel", (t => (e(), i.unobserve(t.target))))];
                return {
                    disconnect() {
        ...
        update: {
            read() {
                for (const t of this.target) rt(t, "uc-light,uc-dark", !this.selActive || bt(t, this.selActive) ? da(t) : "")
            }
        }
    };
    ...
    function da(t) {
        ...
        for (const r of [.25, .5, .75]) {
            ...
            for (const e of a) {
                if (t.contains(e) || e.closest('[class*="-leave"]') && a.some((t => e !== t && bt(t, '[class*="-enter"]')))) continue;
    ...
    var ua = {
            ...
            data: {
                fill: "",
                clsWrapper: "uc-leader-fill",
                clsHide: "uc-leader-hide",
                attrFill: "data-fill"
            },
            computed: {
                fill: ({
                    fill: t
                }, e) => t || Qt(e, "--uc-leader-fill-content")
            },
            connected() {
        ...
        fa = {
            install: function({
                ...
                function e(e, i, n = R, s = R) {
                    i = {
                        ...
                        ...i,
                        i18n: { ...t.i18n,
                            ...null == i ? void 0 : i.i18n
                        }
                    };
                    const o = t.dialog(e(i), i);
                    return m(new Promise((t => {
                ...
                t.dialog = function(e, i) {
                    ...
                    return n.show(), Lt(n.$el, "hidden", (async () => {
                    ...
                    return e((({
                        i18n: e
                    }) => `<div class="uc-modal-body">${k(t)?t:fe(t)}</div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-primary uc-modal-close" autofocus>${e.ok}</button> </div>`), i)
                }, t.confirm = function(t, i) {
                    return e((({
                        i18n: e
                    }) => `<form> <div class="uc-modal-body">${k(t)?t:fe(t)}</div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-default uc-modal-close" type="button">${e.cancel}</button> <button class="uc-button uc-button-primary" autofocus>${e.ok}</button> </div> </form>`), i, (() => Promise.reject()))
                }, t.prompt = function(t, i, n) {
                    const s = e((({
                            i18n: e
                        }) => `<form class="uc-form-stacked"> <div class="uc-modal-body"> <label>${k(t)?t:fe(t)}</label> <input class="uc-input" value="${i||""}" autofocus> </div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-default uc-modal-close" type="button">${e.cancel}</button> <button class="uc-button uc-button-primary">${e.ok}</button> </div> </form>`), n, (() => null), (() => r.value)),
                        {
                            $el: o
                        } = s.dialog,
                        r = Te("input", o);
            ...
            events: [{
                ...
                self: !0,
                handler() {
                    at(this.panel, "uc-margin-auto-vertical") ? nt(this.$el, "uc-flex") : Qt(this.$el, "display", "block"), Oe(this.$el)
                }
            }, {
                name: "hidden",
                self: !0,
    ...
    var ga = {
        ...
        data: {
            ...
            selNavItem: ".uc-navbar-nav > li > a,a.uc-navbar-item,button.uc-navbar-item,.uc-navbar-item a,.uc-navbar-item button,.uc-navbar-toggle",
            dropbarTransparentMode: !1
        },
        computed: {
            navbarContainer: (t, e) => e.closest(".uc-navbar-container")
        },
        watch: {
            items() {
                ...
                for (const i of e) {
                    Qt(i, "flexGrow", t ? Ee(".uc-navbar-nav > li > a, .uc-navbar-item, .uc-navbar-toggle", i).length : "")
                }
            }
        },
        events: [{
            ...
            handler({
                ...
                "remove" === this.getTransparentMode(t) && at(this.navbarContainer, ma) && (st(this.navbarContainer, ma), this._transparent = !0)
            }
        }, {
            name: "hide",
            el() {
            ...
            async handler() {
                await new Promise((t => setTimeout(t))), !this.getActive() && this._transparent && (nt(this.navbarContainer, ma), this._transparent = null)
            }
        }],
        methods: {
    ...
    var va = {
        ...
        events: [{
            ...
            self: !0,
            handler() {
                "reveal" === this.mode && !at(vt(this.panel), this.clsMode) && (xe(this.panel, "<div>"), nt(vt(this.panel), this.clsMode));
                const {
                    body: t,
                    scrollingElement: e
                } = document;
                nt(t, this.clsContainer, this.clsFlip), Qt(t, "touch-action", "pan-y pinch-zoom"), Qt(this.$el, "display", "block"), Qt(this.panel, "maxWidth", e.clientWidth), nt(this.$el, this.clsOverlay), nt(this.panel, this.clsSidebarAnimation, "reveal" === this.mode ? "" : this.clsMode), Oe(t), nt(t, this.clsContainerAnimation), this.clsContainerAnimation && (wa().content += ",user-scalable=0")
            }
        }, {
            name: "hide",
            self: !0,
            ...
            handler() {
                ...
                }(), "reveal" === this.mode && ye(this.panel), st(this.panel, this.clsSidebarAnimation, this.clsMode), st(this.$el, this.clsOverlay), Qt(this.$el, "display", ""), Qt(this.panel, "maxWidth", ""), st(document.body, this.clsContainer, this.clsFlip)
            }
        }, {
    ...
    var ba = {
            ...
            data: {
                selContainer: ".uc-modal",
                selContent: ".uc-modal-dialog",
                minHeight: 150
            },
            computed: {
                container: ({
            ...
            update: {
                read() {
                    return !!(this.content && this.container && ut(this.$el)) && {
                        max: Math.max(this.minHeight, Oe(this.container) - (Pe(this.content).height - Oe(this.$el)))
                    }
                },
                write({
                    max: t
        ...
        $a = {
            ...
            methods: {
                async scrollTo(t) {
                    t = t && Te(t) || document.body, Vt(this.$el, "beforescroll", [this, t]) && (await Ei(t, {
                        offset: this.offset
                    }), Vt(this.$el, "scrolled", [this, t]))
                }
            }
        };
    const ya = new Set;
    ...
    function Sa(t) {
        if (!t.defaultPrevented)
            for (const e of ya) e.$el.contains(t.target) && kt(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Ct(e.$el)))
    }
    var Ia = {
            args: "cls",
            props: {
            ...
            disconnected() {
                for (const [t, e] of this.elementData.entries()) st(t, this.inViewClass, (null == e ? void 0 : e.cls) || "");
            ...
            observe: mn({
                ...
                handler(t) {
                    ...
                    for (const {
                        ...
                        e.has(i) || e.set(i, {
                            cls: it(i, "uc-scrollspy-class") || this.cls
                        });
                        const t = e.get(i);
            ...
            update: [{
                write(t) {
                    for (const [e, i] of this.elementData.entries()) !i.show || i.inview || i.queued ? !i.show && i.inview && !i.queued && this.repeat && this.toggle(e, !1) : (i.queued = !0, t.promise = (t.promise || Promise.resolve()).then((() => new Promise((t => setTimeout(t, this.delay))))).then((() => {
            ...
            methods: {
                toggle(t, e) {
                    ...
                    if (n) {
                        if (null == (i = n.off) || i.call(n), Qt(t, "opacity", !e && this.hidden ? 0 : ""), lt(t, this.inViewClass, e), lt(t, n.cls), /\buc-animation-/.test(n.cls)) {
                            const i = () => ot(t, "uc-animation-[\\w-]+");
                            e ? n.off = qt(t, "animationcancel animationend", i, {
                                self: !0
                            }) : i()
                        }
        ...
        Ca = {
            ...
            connected() {
                this.start = Ea(this.start || this.top), this.end = Ea(this.end || this.bottom), this.placeholder = Te("+ .uc-sticky-placeholder", this.$el) || Te('<div class="uc-sticky-placeholder"></div>'), this.isFixed = !1, this.setActive(!1)
            },
            beforeDisconnect() {
                this.isFixed && (this.hide(), st(this.target, this.clsInactive)), Aa(this.$el), be(this.placeholder), this.placeholder = null
            },
            observe: [wn({
                handler() {
            ...
            events: [{
                ...
                handler() {
                    ...
                    !location.hash || 0 === t.scrollTop || setTimeout((() => {
                        const e = Me(Te(location.hash)),
                            i = Me(this.$el);
                        this.isFixed && U(e, i) && (t.scrollTop = e.top - i.height - je(this.targetOffset, "height", this.placeholder) - je(this.offset, "height", this.placeholder))
                    }))
                }
            }, {
                name: "transitionstart",
                handler() {
                    this.transitionInProgress = qt(this.$el, "transitionend transitioncancel", (() => this.transitionInProgress = null))
                }
            }],
            update: [{
                read({
                    ...
                    s && (Da(this.target), this.hide()), this.active || (({
                        height: t,
                        width: e
                    } = Me(this.$el)), i = Qt(this.$el, "margin")), s && this.show();
                    ...
                    return n = a && !this.showOnUp && p + c === u && m === Math.min(a, Ta(!0, this.$el, 0, !0) - f - c + d) && "visible" === Qt(vt(this.$el), "overflowY"), {
                        start: p,
                        end: m,
                        offset: c,
                        overflow: d,
                ...
                write({
                    ...
                    Qt(o, {
                        ...
                        width: e,
                        margin: i
                    }), (vt(o) !== vt(this.$el) || s ^ It(o) < It(this.$el)) && ((s ? ge : ve)(this.$el, o), o.hidden = !0)
                },
                events: ["resize"]
            }, {
                read({
                ...
                write(t, e) {
                    ...
                    const d = Date.now();
                    if ((d - n > 300 || s !== o) && (t.initScroll = r, t.initTimestamp = d), !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10))
                        if (this.inactive || r < h || this.showOnUp && (r <= h || "down" === s && i || "up" === s && !this.isFixed && !c)) {
                            if (!this.isFixed) return void(ce.inProgress(this.$el) && l > r && (ce.cancel(this.$el), this.hide()));
                            if (this.animation && c) {
                                if (at(this.$el, "uc-animation-leave")) return;
                                ce.out(this.$el, this.animation).then((() => this.hide()), R)
                            } else this.hide()
                        } else this.isFixed ? this.update() : this.animation && c ? (this.show(), ce.in(this.$el, this.animation).catch(R)) : (Da(this.target), this.show())
                },
            ...
            methods: {
                ...
                hide() {
                    ...
                    this.setActive(!1), st(this.$el, this.clsFixed, this.clsBelow), e ? Qt(this.$el, "top", t) : Qt(this.$el, {
                        position: "",
                        top: "",
                        width: "",
                        marginTop: ""
                ...
                update() {
                    ...
                    if (!l) {
                        let s = "fixed";
                        e > o && (r += o - a + n - i, s = "absolute"), Qt(this.$el, {
                            position: s,
                            width: t,
                            marginTop: 0
                        }, "important")
                    }
                    Qt(this.$el, "top", r - n), this.setActive(c), lt(this.$el, this.clsBelow, h), nt(this.$el, this.clsFixed)
                },
                setActive(t) {
                    const e = this.active;
                    this.active = t, t ? (rt(this.target, this.clsInactive, this.clsActive), e !== t && Vt(this.$el, "active")) : (rt(this.target, this.clsActive, this.clsInactive), e !== t && (Da(this.target), Vt(this.$el, "inactive")))
                }
            }
        };
    ...
    var Pa = {
        ...
        async connected() {
            ...
            const t = await this.svg;
            t && (Ma.call(this, t), this.strokeAnimation && function(t) {
                const e = uo(t);
        ...
        methods: {
            async getSvg() {
                return de(this.$el, "img") && !this.$el.complete && "lazy" === this.$el.loading && await new Promise((t => qt(this.$el, "load", t))),
                    function(t, e) {
                        return e && d(t, "<symbol") && (t = Oa(t)[e] || t), t = Te(t.substr(t.indexOf("<svg"))), (null == t ? void 0 : t.hasChildNodes()) && t
    ...
    const _a = K((async t => t ? h(t, "data:") ? decodeURIComponent(t.split(",")[1]) : (await fetch(t)).text() : Promise.reject()));
    ...
    var za = {
            ...
            events: [{
                ...
                handler(t) {
                    !bt(t.current, Na) && ("click" === t.type || t.keyCode === Fn) && (t.preventDefault(), this.show(t.current))
                }
            }, {
                name: "keydown",
                delegate() {
                ...
                handler(t) {
                    const {
                        current: e,
                        keyCode: i
                    } = t, n = bt(this.$el, this.selVertical);
                    let s = i === Ln ? 0 : i === jn ? "last" : i === Wn && !n || i === qn && n ? "previous" : i === Vn && !n || i === Rn && n ? "next" : -1;
                    if (~s) {
                        t.preventDefault();
            ...
            update() {
                ...
                for (const e in this.toggles) {
                    ...
                    Q(i, "role", "tab"), n && (i.id = Ks(this, i), n.id = Ks(this, n), Q(i, "aria-controls", n.id), Q(n, {
                        role: "tabpanel",
                        "aria-labelledby": i.id
                    }))
                }
            ...
            methods: {
                ...
                show(t) {
                    ...
                    this.children.forEach(((t, e) => {
                        lt(t, this.cls, s === e), Q(this.toggles[e], {
                            "aria-selected": s === e,
                            tabindex: s === e ? null : -1
                        })
                    }));
        ...
        Ha = {
            ...
            data: {
                media: 960,
                attrItem: "uc-tab-item",
                selVertical: ".uc-tab-left,.uc-tab-right"
            },
            connected() {
                const t = at(this.$el, "uc-tab-left") ? "uc-tab-left" : !!at(this.$el, "uc-tab-right") && "uc-tab-right";
    ...
    var Fa = {
        ...
        computed: {
            target: ({
                target: t
            }, e) => (t = Et(t || e.hash, e)).length ? t : [e]
        },
        connected() {
            d(this.mode, "media") || (gt(this.$el) || Q(this.$el, "tabindex", "0"), !this.cls && de(this.$el, "a") && Q(this.$el, "role", "button"))
        },
        observe: vn({
            target: ({
                target: t
        ...
        events: [{
            ...
            handler(t) {
                this._preventClick = null, Gt(t) && !I(this._showState) && !this.$el.disabled && (Vt(this.$el, "focus"), qt(document, Ze, (() => Vt(this.$el, "blur")), !0, (t => !this.$el.contains(t.target))), d(this.mode, "click") && (this._preventClick = !0))
            }
        }, {
            ...
            handler(t) {
                ...
                e || !(!I(this._showState) || "blur" !== t.type && bt(this.$el, ":focus") || "blur" === t.type && bt(this.$el, ":hover")) ? e && I(this._showState) && i !== this._showState || (this._showState = e ? i : null, this.toggle("toggle" + (e ? "show" : "hide"))) : i === this._showState && (this._showState = null)
            }
        }, {
            name: "keydown",
            filter() {
            ...
            handler(t) {
                let e;
                (this._preventClick || t.target.closest('a[href="#"], a[href=""]') || (e = t.target.closest("a[href]")) && (!this.isToggled(this.target) || e.hash && bt(this.target, e.hash))) && t.preventDefault(), !this._preventClick && d(this.mode, "click") && this.toggle()
            }
        }, {
            name: "mediachange",
            filter() {
    ...
    return F(Object.freeze({
        ...
        function(t) {
            Ye && window.MutationObserver && (document.body ? requestAnimationFrame((() => ar(t))) : new MutationObserver(((e, i) => {
                document.body && (ar(t), i.disconnect())
            })).observe(document.documentElement, {
                childList: !0
            }))
        }(Ls), F(rr, ((t, e) => Ls.component(e, t))), Ls
}));